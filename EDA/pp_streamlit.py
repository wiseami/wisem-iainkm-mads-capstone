...
playlist_data_df = pd.read_csv("C:\\Users\\Mike\\Documents\\GitHub\\coursera\\wisem-iainkm-mads-capstone\\playlist_data\\playlist_data.csv")
...
#grouped['avg_danceability'] = grouped['danceability'] / grouped['duration_m']
#grouped.head()
...
profile = pp.ProfileReport(merged, 
    explorative=True,
    variables={
        "descriptions": {
